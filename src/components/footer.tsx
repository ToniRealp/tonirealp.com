const navigation = [
    {
        name: "GitHub",
        href: "https://github.com/ToniRealp",
        icon: () => (
    ...
    {
        name: "LinkedIn",
        href: "https://www.linkedin.com/in/toni-realp/",
        icon: () => (
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
    ...
    {
        name: "Gmail",
        href: "mailto:tonirealp@gmail.com",
        icon: () => (
    ...
    <footer className="bg-white">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
                <p className="text-center text-base text-gray-400">&copy; 2021 Toni Realp. All rights reserved.</p>
            </div>
        </div>
    </footer>
);
